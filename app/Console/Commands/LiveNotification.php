...
class LiveNotification extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'live:notification';
     ...
     * @var string
     */
    protected $description = 'Send an notification 1 hour before live start';
    ...
    public function handle()
    {
        ...
        foreach($lives as $live){
            ...
            $time = Carbon::parse($live['start_time'])->subhours(1)->format('Y-m-d H:i');
