...
class LiveNotification5 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'live:notification5';
     ...
     * @var string
     */
    protected $description = 'Send an notification 5 minutes before live start';
    ...
    public function handle()
    {
        ...
        $subhours = Carbon::now()->subMinutes(5);
        ...
        foreach($lives as $live){
            ...
            $time = Carbon::parse($live['start_time'])->subMinutes(5)->format('Y-m-d H:i');
